...
<body>
    ...
    <div class="container">
        ...
        <div class="settings-container">
            ...
            <h3>
            Thanks to our service, after answering a few short questions about your preferences, you will find a properly personalized answer to this query. The questions are based only on actual data regarding: prices, leisure activities and the preferences of the average visitor.<br><br>
